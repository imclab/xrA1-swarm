# IMC Lab Skill Testing Framework — Claude Instructions

This folder is the quality assurance layer for The IMC Lab skill/agent
...
- Skill specs: `IMC Lab Skill Testing Framework/skills/[category]/[name].md`
- Agent specs: `IMC Lab Skill Testing Framework/agents/[tier]/[name].md`
- Catalog: `IMC Lab Skill Testing Framework/catalog.yaml`
- Rubric: `IMC Lab Skill Testing Framework/quality-rubric.md`
...
The IMC Lab skills or agents themselves. `/skill-test` and `/skill-improve` will report that
